...
//}
//
//DataSet Table::GetRow(void* rowID, const SelectionType selection)
//{
//	
//}
//
//TupleType Table::SelectionTupleType(SelectionType selection)
//{
...
//}
//
//DataSet Table::GetRows(const Ranges& ranges, const SelectionType selection)
//{
//	Range range;
//	int rangeColumn;
//	if (ranges.size() == 0)
...
//}
//
//DataSet Table::Include(const Ranges& ranges, const DataSet newData, const SelectionType selection)
//{
//}
//

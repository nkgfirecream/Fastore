...
typedef struct _Service_getHiveState_args__isset {
  _Service_getHiveState_args__isset() : forceUpdate(false) {}
  bool forceUpdate;
...
typedef struct _Service_acquireLock_args__isset {
  _Service_acquireLock_args__isset() : name(false), mode(false), timeout(false) {}
  bool name;
  bool mode;
  bool timeout;
...
typedef struct _Service_escalateLock_args__isset {
  _Service_escalateLock_args__isset() : lockID(false), timeout(false) {}
  bool lockID;
  bool timeout;
...
class ServiceProcessor : public ::apache::thrift::TProcessor {
 protected:
  boost::shared_ptr<ServiceIf> iface_;
  virtual bool process_fn(apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot, std::string& fname, int32_t seqid, void* callContext);
 private:
  std::map<std::string, void (ServiceProcessor::*)(int32_t, apache::thrift::protocol::TProtocol*, apache::thrift::protocol::TProtocol*, void*)> processMap_;

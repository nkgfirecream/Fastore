...
class ServiceConfig {
 public:
  ...
  static const char* ascii_fingerprint; // = "835665D75A6988F4B1E8E4CCE0D80C0F";
  static const uint8_t binary_fingerprint[16]; // = {0x83,0x56,0x65,0xD7,0x5A,0x69,0x88,0xF4,0xB1,0xE8,0xE4,0xCC,0xE0,0xD8,0x0C,0x0F};

-- using 1351115029 as a seed to the RNG
...
from
	lineitem
where
	l_shipdate <= date( '1998-12-01','-86 day')
group by
	l_returnflag,
	l_linestatus
order by
...
where
	...
	and o_orderdate < date( '1995-02-01', '+3 month')
	and exists (
		select
			*
		from
...
where
	...
	and o_orderdate < date('1993-01-01', '+1 year')
group by
	n_name
order by
	revenue desc
...
where
	...
	and o_orderdate < date('1994-03-01', '+3 month')
	and l_returnflag = 'R'
...
where
	...
	and l_shipdate < date('1995-12-01' , '+1 month')
limit -1;
...
create view revenue0 as
	...
	where
		...
		and l_shipdate < date('1993-05-01', '+3 month')
	group by
		l_suppkey;
...
where
	...
	and p_size in (35, 25, 11, 46, 30, 42, 33, 9)

...
void checkSQLiteResult(int result)
{
	...
	switch (result)
	{
		...
		case SQLITE_IOERR       : message = "Some kind of disk I/O error occurred"; break;
		case SQLITE_CORRUPT     : message = "The database disk image is malformed"; break;
		...
		default					: message = "unknown query processor error."; break;
	}
	throw fastore::client::ClientException(message);	
}